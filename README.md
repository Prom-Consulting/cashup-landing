...
журнал списаний, коды приглашения владельца, клиенты платформы с выпуском карт, заявки с лендинга,
профиль.

**Кабинет заведения:** регистрация по коду приглашения, обзор с состоянием подписки, витрина для
каталога (категория, описание, логотип, фотографии, ссылки), журнал списаний с поиском, счета на
продление, адрес вебхука для 1С с перевыпуском токена, профиль. Если человек работает в нескольких
