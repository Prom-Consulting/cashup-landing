...
export function BonusCalculator() {
  ...
  return (
    <div ref={root} className="grid overflow-hidden rounded-[36px] bg-graphite text-paper lg:grid-cols-[1.1fr_1fr]">
      ...
      <div className="relative bg-paper/5 px-7 pt-16 pb-14 sm:p-12 sm:pt-16">
        <div className="relative mx-auto max-w-[420px] rotate-[1.5deg]">
          <div className="receipt bg-paper px-7 pt-8 pb-12 text-graphite">
            <p className="display text-4xl">Чек</p>
            <p className="mt-1 text-sm opacity-70">Кофейня, партнёр Loal</p>

            <dl aria-live="polite" className="mt-6 flex flex-col gap-3 border-b-2 border-dashed border-smoke pb-5">
            ...
            <div className="mt-6" aria-hidden="true">
              <div className="h-5 overflow-hidden rounded-full bg-smoke/50">
                <div
                  data-bar-check
                  className="flex h-full overflow-hidden rounded-full"
                  style={{ width: initial.checkWidth }}
                >
                  <div data-bar-bonus className="h-full bg-flame" style={{ width: initial.bonusWidth }} />
                  <div className="h-full flex-1 bg-graphite" />
                </div>
              </div>
            ...
            <div className="mt-6 rounded-2xl bg-cream px-4 py-3">
              ...
              <div className="mt-2 h-2 overflow-hidden rounded-full bg-paper" aria-hidden="true">
                <div
                  data-bar-left
                  className="h-full rounded-full bg-flame-ink"
