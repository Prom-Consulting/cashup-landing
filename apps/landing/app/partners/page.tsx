...
export const metadata: Metadata = {
  title: "Партнёры на карте Бишкека",
  description:
    "Где принимают бонусы Loal: кофейни, салоны красоты, магазины, фитнес и сервисы Бишкека с их процентом оплаты бонусами.", // Своё превью в мессенджерах; картинка берётся из app/opengraph-image.png.
  ...
  openGraph: {
    ...
    title: "Партнёры на карте Бишкека — Loal",
    description:
